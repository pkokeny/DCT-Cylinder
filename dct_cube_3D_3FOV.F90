...
character(24) :: filenameCk
character(8) :: date
character(10) :: time
character(5) :: zone
integer,dimension(8) :: values

parameter (cropf = 64, lor = 4, dimxyz=((3*cropf)/2+1), radius=2, &
partsp=16, npartFOVxyz=((dimxyz-1)/partsp), lowxyz=((dimxyz-1)*2)/cropf, &
field=3.0D0, gamma=2.675D8, vf=6.5917969D-3, dX=(10.0D-6/64.0D0)/vf, pi=3.14159265D0)
...
complex*8, dimension(2,2,2) :: low_3D_k
...
(/ FFTW_REDFT00, FFTW_REDFT00, FFTW_REDFT00 /),FFTW_ESTIMATE)
    ...
    WRITE(filenameCk,'("Complex_k_R02_3FOV",I2,".dat")') t
